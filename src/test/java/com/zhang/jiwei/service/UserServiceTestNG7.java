...
public class UserServiceTestNG7 extends AbstractTestNGSpringContextTests {
    ...
    public void userControllerTest() throws Exception {
        ...
        params.add("id","1");
        params.add("age","12");
        params.add("name","lisi");
        mockMvc.perform(get("/updateUser").params(params))
                .andDo(print())
                .andExpect(mvcResult -> assertEquals("lisi", JSONObject.parseObject(mvcResult.getResponse().getContentAsString()).getString("name")));
    }
